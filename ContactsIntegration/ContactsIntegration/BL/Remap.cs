    ...
    public class Remap
    {
        ...
        public static PBContact IRISContactToPowerBuilderContact(Iris.ContactDetails contactDetails)
        {
            ...
            foreach (Iris.ContactAddress contactAddress in contactDetails.ContactAddresses)
            {
                ...
                { address.AddressPrologue = ""; }
                    ...
                    {
                        int? streetNumber = contactAddress.ContactUrbanRuralAddress.StreetNumber.GetValueOrDefault(0);
                        string streetAddress = string.Format("{0} {1} {2}",
                            //contactAddress.ContactUrbanRuralAddress.StreetNumber, 21-08-2014 BP Changed to eliminate zero as a street number
                            streetNumber == 0 ? String.Empty : (Object)streetNumber,
        ...
        private static Address RemapCommonAddress(Iris.ContactAddress contactAddress, string syncType="")
        {
            ...
            if (contactAddress.ContactUrbanRuralAddress != null)
            {
                ...
                string streetAddress = string.Format("{0} {1} {2}",
                    //contactAddress.ContactUrbanRuralAddress.StreetNumber      21-08-2014 BP Changed this to eliminate zero as a street number
                    address.HouseNumber == 0 ? String.Empty : (Object)address.HouseNumber,
                    contactAddress.ContactUrbanRuralAddress.StreetName.SafeTrimOrEmpty(),
                    contactAddress.ContactUrbanRuralAddress.StreetDirection.SafeTrimOrEmpty()).SafeTrimOrEmpty();
                ...
                {
                    int? streetNumber = contactAddress.ContactUrbanRuralAddress.StreetNumber.GetValueOrDefault(0);
                    // 21-08-2014 BP Changed the next line to eliminate zero as a street number 
                    ...
                    address.AddressNumberText = (streetNumber != 0 ? streetNumber.Value.ToString() : string.Empty) + contactAddress.ContactUrbanRuralAddress.StreetAlpha;
